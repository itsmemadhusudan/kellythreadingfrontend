...
const AdminBranchPage = lazy(() => import('../pages/admin/BranchPage').then((m) => ({ default: m.default })));
...
const AdminSalesDetailsPage = lazy(() => import('../pages/admin/SalesDetailsPage').then((m) => ({ default: m.default })));
    ...
    <Suspense fallback={<PageLoader />}>
      <Routes>
        ...
        >
          ...
          <Route path="branch" element={<AdminBranchPage />} />
          <Route path="create-vendor" element={<AdminCreateVendorPage />} />
          <Route path="branches" element={<AdminBranchesPage />} />
          <Route path="sales" element={<AdminSalesPage />} />
          <Route path="sales/details" element={<AdminSalesDetailsPage />} />
